...
concept NodesCfg_Concept =
    ...
    && requires(Cfg cfg, typename Cfg::NodeT node, Cool::NodeId id, Cool::NodeDefinitionAndCategoryName<typename Cfg::NodeDefinitionT> def_and_cat_name, typename Cfg::NodeDefinitionT def, Graph<typename Cfg::NodeT> graph) {
           // clang-format off
