...
auto NodesEditor::handle_link_creation() -> bool
{
    PinId from_pin_id;
    PinId to_pin_id;
...
auto NodesEditor::handle_link_deletion() -> bool
{
...
auto NodesEditor::handle_node_deletion() -> bool
{
...
auto NodesEditor::wants_to_delete_selection() const -> bool
{
...
auto NodesEditor::wants_to_open_nodes_menu() const -> bool
{
    return _window_is_hovered
...
void NodesEditor::open_nodes_menu()
{
...
auto NodesEditor::draw_nodes_library_menu_ifn(
...
auto NodesEditor::imgui_nodes_menu(
    NodesConfig const&  nodes_cfg,
    NodesLibrary const& library,
