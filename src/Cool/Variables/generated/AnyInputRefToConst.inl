...
using AnyInputRefToConst = std::variant<
    ...
    std::reference_wrapper<const Input<Cool::TextureDescriptor_FromFile>>,
    std::reference_wrapper<const Input<Cool::TextureDescriptor_FromWebcam>>,
    ...
    std::reference_wrapper<const Input<Cool::MidiCc>>>;