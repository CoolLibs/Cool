...
auto Exporter::export_image_with_current_settings_using_a_task(Time time, Time delta_time, Polaroid const& polaroid) -> std::filesystem::path
{
    auto path = File::find_available_path(_gui.image_export_path());
