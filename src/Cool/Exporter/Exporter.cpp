...
auto Exporter::export_image_immediately_using_a_task(Time time, Time delta_time, Polaroid const& polaroid) -> std::filesystem::path
{
    auto path = _gui.image_export_path();
