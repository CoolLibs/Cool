...
public:
    ...
    auto export_image_with_current_settings_using_a_task(Time time, Time delta_time, Polaroid const& polaroid, ExportPathChecks const& path_checks) -> std::filesystem::path;
