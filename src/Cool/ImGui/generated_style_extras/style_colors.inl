 ...
 * Instead, go to "style_generator_extras.py" and edit the "style_colors" function there.
 * -----------------------------------------------------------------------------
 */
...
ImVec4 node_link{0.f, 0.f, 0.f, 1.f};
ImVec4 node_link_hovered{0.f, 0.f, 0.f, 1.f};
ImVec4 url_link{0.f, 0.f, 0.f, 1.f};
ImVec4 url_link_hovered{0.f, 0.f, 0.f, 1.f};
