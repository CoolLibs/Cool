...
struct WindowConfig {
    ...
    BuildMode   cap_framerate_on_startup_if = BuildMode::Any;     // Whether the framerate should be capped or not (this can later be changed at runtime through window.cap_framerate_if())
