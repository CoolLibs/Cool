...
void WindowFactory_ImplVulkan::shut_down(WindowManager& window_manager)
{
...
void WindowFactory_ImplVulkan::setup_main_window(Window_Vulkan& window)
{
    setup_imgui(window);
}

void WindowFactory_ImplVulkan::setup_secondary_window(Window_Vulkan&, WindowManager&)
{
}
...
Window_Vulkan& WindowFactory_ImplVulkan::make_window(const WindowConfig& config, WindowManager& window_manager)
{
...
void WindowFactory_ImplVulkan::setup_imgui(Window_Vulkan& window)
{
