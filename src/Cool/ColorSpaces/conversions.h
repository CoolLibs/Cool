...
[[nodiscard]] auto HSLuv_from_XYZ(glm::vec3 c) -> glm::vec3;
[[nodiscard]] auto XYZ_from_HSLuv(glm::vec3 c) -> glm::vec3;
[[nodiscard]] auto HSLuv_from_sRGB(glm::vec3 c) -> glm::vec3;
[[nodiscard]] auto sRGB_from_HSLuv(glm::vec3 c) -> glm::vec3;
[[nodiscard]] auto HSLuv_from_LinearRGB(glm::vec3 c) -> glm::vec3;
[[nodiscard]] auto LinearRGB_from_HSLuv(glm::vec3 c) -> glm::vec3;
[[nodiscard]] auto HSLuv_from_CIELAB(glm::vec3 c) -> glm::vec3;
[[nodiscard]] auto CIELAB_from_HSLuv(glm::vec3 c) -> glm::vec3;
