...
/// </summary>
/// <param name="filepath">The destination path for the image : something like "out/myImage.png". If folders in the path don't already exist they will be created.</param>
...
void ExportPng(const char* filepath, int width, int height, void* data, bool bFlipVertically = true);
