...
public:
	...
	void setUniform(const char* uniformName, int v);
	void setUniform(const char* uniformName, unsigned int v);
	void setUniform(const char* uniformName, bool v);
	void setUniform(const char* uniformName, float v);
	void setUniform(const char* uniformName, const glm::vec2& v);
	void setUniform(const char* uniformName, const glm::vec3& v);
	void setUniform(const char* uniformName, const glm::vec4& v);
	void setUniform(const char* uniformName, const glm::mat2& mat);
	void setUniform(const char* uniformName, const glm::mat3& mat);
